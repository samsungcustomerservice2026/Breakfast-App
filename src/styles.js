...
export const S = {
  ...
  orderRowFoot: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", borderTop: `1px solid ${line}` },
...
export const U = {
  ...
  sheetTitle: { margin: "0 0 12px", fontSize: 20, fontWeight: 800, textAlign: "right", flexShrink: 0 },
