...
export const S = {
  ...
  signCard: { background: paper, border: `1px solid ${line}`, borderRadius: 20, padding: "28px 24px", width: "100%", maxWidth: 420, boxShadow: "0 18px 50px -30px rgba(80,50,20,.4)" },
  brandRow: { display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: 8, marginBottom: 22 },
  logoImg: { width: 72, height: 72, borderRadius: "50%", objectFit: "cover", flexShrink: 0, background: paper, border: `1px solid ${line}` },
  logoImgLg: { width: 120, height: 120, borderRadius: "50%", objectFit: "cover", flexShrink: 0, background: paper, border: `2px solid ${line}` },
  logoImgXl: { width: 148, height: 148, borderRadius: "50%", objectFit: "cover", flexShrink: 0, background: paper, border: `3px solid ${line}`, display: "block", margin: "0 auto 12px" },
  ...
  authMemeCard: { background: paper, borderRadius: 20, padding: "12px 12px 16px", width: "min(420px, 92vw)", textAlign: "center", boxShadow: "0 24px 60px -18px rgba(0,0,0,.5)", cursor: "default" },
  ...
  header: { position: "sticky", top: 0, zIndex: 20, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 16px", background: "rgba(251,246,236,.92)", backdropFilter: "blur(8px)", borderBottom: `1px solid ${line}`, flexWrap: "wrap", gap: 8 },
  brandRowSm: { display: "flex", gap: 12, alignItems: "center" },
  logoImgSm: { width: 72, height: 72, borderRadius: "50%", objectFit: "cover", flexShrink: 0, background: paper, border: `2px solid ${line}` },
  headerTitle: { fontFamily: "'Cairo','Fraunces',Georgia,serif", fontSize: 22, fontWeight: 800, letterSpacing: 0, lineHeight: 1.2 },
